...
**📍 You are here:** [Main Guide](../../README.md) → **Tasks Template**

## Quick Navigation
- **📚 Learn Process:** Tasks Phase Guide — upstream supporting file is not included in this project copy
- **📖 See Example:** Simple Feature Tasks — upstream supporting file is not included in this project copy
- **⚡ Execute Tasks:** Implementation Guide — upstream supporting file is not included in this project copy
...
[← Design Template](design-template.md) | [Main Guide](../../README.md)
