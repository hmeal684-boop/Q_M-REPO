...
**📍 You are here:** [Main Guide](../../README.md) → **Design Template**

## Quick Navigation
- **📚 Learn Process:** Design Phase Guide — upstream supporting file is not included in this project copy
- **📖 See Example:** Complex System Design — upstream supporting file is not included in this project copy
- **🧠 Decision Help:** Decision Frameworks — upstream supporting file is not included in this project copy
