...
function StaffWorkspace({ session, onLogout, sessionError }) {
  ...
  const [data, setData] = useState({ enrollments: [], reviews: [], leads: [], escalations: [], course_dates: [], content: null, dashboard: {} });
  ...
  async function loadData() {
    ...
    const paths = ["overview", "enrollments", "accounts"].includes(tab)
      ? ["dashboard", "enrollments", ...(financeAccess ? ["payment-reviews"] : [])]
